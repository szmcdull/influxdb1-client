...
`go get github.com/szmcdull/influxdb1-client/v2`
Then, in your import declaration section of your Go file, paste the following:
`import "github.com/szmcdull/influxdb1-client/v2"`

If you get the error `build github.com/user/influx: cannot find module for path github.com/szmcdull/influxdb1-client/v2` when trying to build:
change your import to:
```go
import(
	_ "github.com/szmcdull/influxdb1-client" // this is important because of the bug in go mod
	client "github.com/szmcdull/influxdb1-client/v2"
)
```
